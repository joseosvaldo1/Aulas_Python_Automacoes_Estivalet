...
element_entry_cep = driver.find_element(By.ID, 'cep')
element_entry_cep.send_keys('60540-285')

element_button_pesquisar = driver.find_element(By.XPATH, '//button[.="Pesquisar"]')
element_button_pesquisar.click()

#time.sleep(5)
wait = WebDriverWait(driver, 10)
condition = EC.text_to_be_present_in_element_attribute((By.ID, 'rua'),'value', 'Rua Coronel João Correia')
