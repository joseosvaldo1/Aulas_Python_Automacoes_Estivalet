"""
Automação Web - Parte XII:

* Aguardando Um Elemento Criado Dinamicamente:
...
button = driver.find_element(By.XPATH, '//button[.="Start 2"]')
button.click()

wait = WebDriverWait(driver, 10)
condition = EC.presence_of_element_located((By.XPATH, '//p[.="Hello Dynamic Element Created!"]'))
