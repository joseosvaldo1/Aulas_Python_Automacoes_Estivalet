"""
Automação Web - Parte XIII:

* Aguardando Um Elemento Ser Clicável:
...
button = driver.find_element(By.XPATH, '//button[.="Enable"]')
button.click()

wait = WebDriverWait(driver, 10)
condition = EC.element_to_be_clickable((By.XPATH, '//form[@id="input-example"]/input'))
